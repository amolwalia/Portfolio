...
function WorkPage() {
  const projects = [
    ...
    },
    {
      ...
      year: "2023",
      image: "https://images.unsplash.com/photo-1657757996603-acec063f1d9b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHxtaW5pbWFsJTIwZGVzaWduJTIwd29ya3NwYWNlfGVufDF8fHx8MTc2ODk3NTMxMXww&ixlib=rb-4.1.0&q=80&w=1080"
    }
  ];
  return /* @__PURE__ */ jsx("section", { className: "min-h-screen py-32 px-8 relative", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 gap-16", children: projects.map((project, index) => /* @__PURE__ */ jsx(ProjectCard, { ...project, index }, index)) }),
    /* @__PURE__ */ jsx(
      motion.div,
      {
        initial: { opacity: 0, y: 30 },
