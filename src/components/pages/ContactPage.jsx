  ...
  return /* @__PURE__ */ jsx("section", { className: "min-h-screen py-32 px-8 relative flex items-center", children: /* @__PURE__ */ jsx("div", { className: "max-w-6xl mx-auto w-full", children: /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-16", children: [
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-6 mb-12", children: contactInfo.map((item, index) => /* @__PURE__ */ jsxs(
            motion.a,
            {
              href: item.href,
              ...
              children: [
                /* @__PURE__ */ jsx("div", { className: "w-12 h-12 border border-neutral-700 rounded-full flex items-center justify-center group-hover:border-white transition-colors", children: /* @__PURE__ */ jsx(item.icon, { className: "w-5 h-5" }) }),
          ...
          /* @__PURE__ */ jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "flex gap-4", children: socials.map((social, index) => /* @__PURE__ */ jsx(
                  motion.a,
                  {
                    href: social.href,
                    className: "w-12 h-12 border border-neutral-700 rounded-full flex items-center justify-center hover:border-white hover:bg-white hover:text-black transition-all",
    ...
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        className: "border border-neutral-800 rounded-2xl p-8 bg-black/40 backdrop-blur-sm",
        children: [
          /* @__PURE__ */ jsx(
            "h2",
            {
              className: "text-2xl mb-6 uppercase tracking-wide",
